  ...
  render() {
    return html`
      <section>
        ...
        <p>
          Note that we're using the <code>helium-end</code> event here to know
          when the animation is over so that we can enable the input again at
          that point.
        </p>
        <p>
